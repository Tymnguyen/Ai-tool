...
// Định nghĩa biến $total_commission với giá trị mặc định là 0
$total_commission = 0.0;

// Lấy tổng số tiền hoa hồng từ bảng users
...
// Định nghĩa biến $transactions với giá trị mặc định là một mảng rỗng
$transactions = [];

// Lấy chi tiết các giao dịch rút tiền từ bảng withdrawals

...
// Lấy URL hiện tại của script đang chạy
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' || $_SERVER['SERVER_PORT'] == 443) ? "https://" : "http://";
$current_url = $protocol . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];

// Đọc dữ liệu thô từ yêu cầu POST của PayPal
...
// Chuẩn bị dữ liệu để xác minh với PayPal
...
// Log full URL của webhook
log_full_url($current_url, $myPost);

// Gửi yêu cầu xác minh tới PayPal
...
if (strcmp($res, "VERIFIED") == 0) {
    ...
    // Ghi lại thông tin cho debugging
    ...
    // Xử lý phản hồi không xác định từ PayPal

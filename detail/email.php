                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=email" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/luna.png" class="card-img">
                                <h3>Email</h3>
                                <p>Tùy chỉnh Email Lạnh tức thì với Luna. Những tin nhắn tự động không còn hiệu quả ngày nay. Có được nhiều phản hồi hơn trên email lạnh của bạn với Luna - ứng dụng phần mềm đầu tiên trên thế giới sử dụng trí tuệ nhân tạo để đề xuất các thông tin khách hàng tiềm năng chất lượng cao mỗi ngày và gửi cho họ những email cá nhân mà họ xứng đáng nhận.</p>
                                <a href="https://getluna.dev/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/pos.png" class="card-img">
                                <h3>Email & CRM</h3>
                                <p>Gửi Email Lạnh Dễ Dàng Hơn Bao Giờ Hết. Công cụ tuyệt vời cho việc tiếp cận qua email với những tin nhắn nghe có vẻ cá nhân và truy cập vào nền tảng tiếp cận toàn diện.</p>
                            ...
                            <div class="card">
                                ...
                                <p>Trình quản lý marketing trí tuệ nhân tạo của TinyEinstein có thể giúp bạn phát triển doanh nghiệp Shopify của mình nhanh gấp 10 lần. Là một trong những nền tảng email marketing trí tuệ nhân tạo tốt nhất cho thương mại điện tử.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>Email & CRM</h3>
                                <p>High-level giúp bạn quản lý quy trình bán hàng hiệu quả hơn với công nghệ trí tuệ nhân tạo tiên tiến. Nền tảng cung cấp một cái nhìn thống nhất về tất cả hoạt động bán hàng của bạn, giúp bạn đưa ra quyết định thông minh trong thời gian thực. Với High-level, bạn có thể tận hưởng sự nâng cao năng suất, cải thiện sự hợp tác và tăng cường kết quả bán hàng của mình.</p>
                                <a href="https://www.gohighlevel.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sma.png" class="card-img">
                                <h3>Email & CRM</h3>
                                <p>Tạo hàng nghìn email và tin nhắn cá nhân chỉ trong vài giây và nhận được nhiều phản hồi hơn gấp 8 lần với Smartwriter.ai. Tự động hóa quá trình viết email và làm việc gấp 40 lần so với việc tạo ra đầu ra bằng cách sử dụng công nghệ nhanh hơn và tiết kiệm chi phí.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>Email & CRM</h3>
                                <p>Thay đổi cách bạn làm việc với sức mạnh của tự động hóa trên một nền tảng trực quan. Xây dựng và tự động hóa mọi thứ từ các nhiệm vụ và quy trình công việc đến các ứng dụng và hệ thống một cách dễ dàng. Nói lời chia tay với nhiều nền tảng và chào đón tích hợp liền mạch, với hàng ngàn tích hợp ứng dụng sẵn có và khả năng kết nối với bất kỳ ứng dụng trực tuyến nào bằng các công cụ mã không cần code mạnh mẽ của chúng tôi. Tối ưu hóa quy trình làm việc và tối đa hóa năng suất của bạn với Make.com.</p>

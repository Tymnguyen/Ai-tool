                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                            <a href="../customer.php?origin=aias" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/tl.png" class="card-img">
                                <h3>Meeting Assistant</h3>
                                <p>Được hỗ trợ bởi GPT. Trợ lý họp AI sẽ viết ghi chú họp cho bạn. Bạn chỉ cần tập trung vào cuộc họp. Là thiết bị ghi âm cuộc họp có khả năng chuyển văn bản thành chữ và tóm tắt cuộc gọi với khách hàng, tiềm năng và đội nhóm của bạn. Tổng quan đầy đủ, ghi chú và đoạn video ngắn từ cuộc họp, tất cả tích hợp với các ứng dụng yêu thích của bạn.</p>
                                <a href="https://tldv.cello.so/MSpiPB5E2Kj" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/myask.png" class="card-img">
                                <h3>AI Assistant</h3>
                                <p>Tạo ChatGPT riêng của bạn và thêm nó vào trang web bằng cách thêm nội dung của bạn. Tiết kiệm thời gian tìm kiếm và nhanh chóng nhận câu trả lời từ tất cả các tài liệu của bạn.</p>
                                <a href="https://myaskai.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/osai.png" class="card-img">
                                <h3>Business Assistant</h3>
                                <p>AI tùy chỉnh cho doanh nghiệp của bạn. Cho phép nhóm hoặc người tiêu dùng của bạn kết nối với cơ sở kiến thức nội bộ, xử lý tài liệu, bảng tính và quy trình theo cách mới và sáng tạo bằng cách sử dụng sức mạnh của trí tuệ nhân tạo.</p>
                                <a href="https://osher.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/vowel.png" class="card-img">
                                <h3>Meeting Assistant</h3>
                                <p>Cuộc họp AI cho các nhóm hoạt động nhanh chóng. Vowel là công cụ AI cho phép nhóm tổ chức, tóm tắt, tìm kiếm và chia sẻ cuộc họp video - không cần bất kỳ tiện ích bổ sung nào. Sử dụng mã: INSIDR để có gói trả phí.</p>
                                <a href="https://www.vowel.com/lp/insidr-and-vowel" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/air.jpg" class="card-img">
                                <h3>Meeting Assistant</h3>
                                <p>Airgram hỗ trợ ghi âm cuộc họp, chuyển văn bản thành chữ và tóm tắt, cũng như chia sẻ để bạn có thể tập trung vào cuộc họp của mình thay vì việc ghi chú. Tận dụng tối đa các cuộc gặp gỡ với các bên liên quan nội bộ và khách hàng của bạn.</p>
                                <a href="https://app.airgram.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

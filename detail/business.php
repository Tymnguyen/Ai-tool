                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=business" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/task.png" class="card-img">
                                <h3>Workspace & productivity</h3>
                                <p>Một bộ não thứ hai cho đội ngũ kinh doanh của bạn. Một danh sách kỳ diệu để phân tách các vấn đề phức tạp và vẽ ra tư duy chung của bạn. Mở khóa trí tuệ đồng tác giả của bạn và kết nối các nhiệm vụ, ghi chú và nhóm trong một không gian làm việc thống nhất. Công cụ viết AI, ghi chú và tài liệu, nhiệm vụ và dự án, sơ đồ tư duy, trò chuyện video và nhiều hơn nữa. </p>
                                <a href="https://www.taskade.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/notion.png" class="card-img">
                                <h3>Workspace & productivity</h3>
                                <p>Tận dụng sức mạnh vô hạn của trí tuệ nhân tạo trong bất kỳ trang Notion nào. Viết nhanh hơn, nghĩ lớn hơn và tăng cường sự sáng tạo. Tất cả các wiki, tài liệu và dự án của bạn trong một nơi. Notion là không gian làm việc kết nối nơi công việc tốt hơn và nhanh hơn diễn ra.</p>
                                <a href="https://www.notion.so/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/cody.png" class="card-img">
                                <h3>Al business assistant</h3>
                                <p>Trợ lý trí tuệ nhân tạo của bạn cho doanh nghiệp. Giống như ChatGPT, Cody là một trợ lý trí tuệ nhân tạo thông minh. Tuy nhiên, bạn có thể sử dụng cơ sở kiến thức của riêng mình để giảng dạy Cody về công ty, nhóm làm việc, quy trình và khách hàng của bạn. Sử dụng Cody để hỗ trợ đội ngũ của bạn, cung cấp hướng dẫn, hỗ trợ trong quá trình nảy ra ý tưởng, giải quyết vấn đề và cung cấp sự trợ giúp sáng tạo.</p>
                                <a href="https://meetcody.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/can.png" class="card-img">
                                <h3>Sales</h3>
                                <p>Convolo là một trong những công cụ bán hàng tốt nhất cho doanh nghiệp. Cung cấp các công cụ giao tiếp giúp tăng doanh số bán hàng. Tăng cường ROI cho Chiến dịch Truyền đạt & Chiến dịch Gọi đi: Gọi từng khách hàng tiềm năng mới trong vòng một phút. Tiếp cận với nhiều Triển vọng hơn với Chiến dịch Gọi đi của bạn</p>
                                <a href="https://convolo.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            <div class="card">
                                <img src="./img/brow.png" class="card-img">
                                <h3>Extract data</h3>
                                <p>Trích xuất và giám sát dữ liệu trong vài giây với browse AI. Dễ dàng huấn luyện robot mà không cần mã code.</p>
                                <a href="https://www.browse.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ori.png" class="card-img">
                                <h3>Sales</h3>
                                <p>Tạo chatbot AI của riêng bạn chỉ trong vài phút. Tương tác với khán giả bằng khả năng gần như giống con người với trí tuệ hội thoại mạnh mẽ dành cho bán hàng. Hơn 120 ngôn ngữ. Được cung cấp bởi Oriserve, công nghệ trí tuệ hội thoại hàng đầu để nâng cao doanh số bán hàng, từ Google và chatGPT3 của OpenAI.</p>
                                <a href="https://orimon.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/re.png" class="card-img">
                                <h3>AI Outreach Videos</h3>
                                <p>Thu hút nhiều cuộc họp hơn bằng cách thu hút khách hàng tiềm năng của bạn. Với video tùy chỉnh, bạn có thể tạo ra tác động lớn trong thời gian ngắn mà không phải làm phiền với việc tạo ra từng video riêng lẻ. RepliQ cho phép bạn cung cấp những thông điệp cá nhân hóa mang lại kết quả, đồng thời giúp bạn tương tác với khán giả trong các hoạt động tiếp cận lạnh một cách toàn diện, chỉ từ một hình ảnh sản phẩm duy nhất.</p>
                                <a href="https://www.repliq.co/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/gui.png" class="card-img">
                                <h3>Create video documentations</h3>
                                <p>Giải thích các quy trình phức tạp nhất trong vài giây với tài liệu video do AI tạo ra. AI có thể tạo ra các hướng dẫn cách thực hiện tuyệt vời. AI có thể tạo ra các quy trình tiêu chuẩn hoạt động tuyệt vời. Guidde, nền tảng AI sinh sáng cho doanh nghiệp, giúp đội ngũ của bạn tạo ra tài liệu video nhanh hơn 11 lần.</p>
                                <a href="https://www.guidde.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/bot1.png" class="card-img">
                                <h3>AI Chatbot</h3>
                                <p>Botnation.ai là nền tảng AI trò chuyện cuối cùng cho phép doanh nghiệp xây dựng và triển khai chatbot thông minh một cách dễ dàng. Công nghệ xử lý ngôn ngữ tự nhiên tiên tiến và giao diện người dùng thân thiện giúp doanh nghiệp tạo ra trải nghiệm trò chuyện hấp dẫn và cá nhân hóa cho khách hàng của mình. Cho dù bạn đang tìm cách cải thiện dịch vụ khách hàng, tăng tỷ lệ chuyển đổi hoặc tối ưu hóa quy trình, Botnation.ai có tất cả những gì bạn cần để thành công trong lĩnh vực trí tuệ hội thoại.</p>
                                <a href="https://botnation.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/hi.png" class="card-img">
                                <h3>Customer support</h3>
                                <p>Hỗ trợ khách hàng dễ dàng với trí tuệ nhân tạo. Cung cấp hỗ trợ nhanh chóng và cá nhân hóa. Chạy phần mềm từ bên trong Gmail.</p>
                                <a href="https://hiver.referralrock.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/pos.png" class="card-img">
                                <h3>Email</h3>
                                <p>Postaga cung cấp các công cụ SEO AI ngoài trang để giúp bạn mang lại nhiều lưu lượng truy cập hơn cho trang web của mình. Đó là một trình tạo chiến dịch tiếp cận phân tích nội dung trang web của bạn và tìm các liên hệ có liên quan để liên kết ngược và chia sẻ.Postaga thường khám phá thông tin liên hệ dựa trên loại chiến dịch. Bạn sẽ nhận được một số bố cục chiến dịch để chỉ định mục tiêu của mình và trình tạo trình tự để tạo email lạnh. Nhưng nó cũng tạo ra các ý tưởng chiến dịch tùy chỉnh cho các email được nhắm mục tiêu.</p>
                                <a href="https://postaga.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ot.png" class="card-img">
                                <h3>Summarizer</h3>
                                <p>Ghi lại và chia sẻ những hiểu biết từ cuộc họp. Otter ghi lại cuộc họp, ghi chú ngay lập tức và tạo ra một bản tóm tắt tự động để chia sẻ với mọi người và giúp bạn ghi nhớ mọi thứ.</p>
                                <a href="https://otter.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/hut.png" class="card-img">
                                <h3>Startup & assistant</h3>
                                <p>Tải lên một tệp PDF và nhận câu trả lời từ đó. Tạo Báo cáo Nhanh Gấp 100 lần. Hiểu Tài liệu Kỹ thuật Nhanh Gấp 100 lần. Phân tích Tài liệu Pháp lý Nhanh Gấp 100 lần.</p>
                                <a href="https://www.humata.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sheet.png" class="card-img">
                                <h3>Spreadsheet</h3>
                                <p>Có sẵn cho Google Sheets và Excel (Sắp ra mắt). Bỏ qua việc học tập và bắt đầu làm việc ngay. Sử dụng trí tuệ nhân tạo để chuyển đổi hướng dẫn văn bản của bạn thành công thức Google Sheet một cách nhanh chóng. (Sẽ ra mắt trong 2-3 tuần tới).</p>
                                <a href="https://www.sheetai.app/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/dime.png" class="card-img">
                                <h3>Startup</h3>
                                <p>Xác minh ý tưởng kinh doanh dựa trên trí tuệ nhân tạo. Đối với bất kỳ startup nào, nghiên cứu thị trường do trí tuệ nhân tạo hỗ trợ. Tận dụng trí tuệ nhân tạo để nhanh chóng khám phá cách công ty của bạn có thể phát triển và làm thế nào để thâm nhập vào bất kỳ ngành nghề nào.</p>
                                <a href="https://www.dimeadozen.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/idea.png" class="card-img">
                                <h3>Startup</h3>
                                <p>Biến ý tưởng kinh doanh của bạn thành hiện thực. Phần mềm quản lý kế hoạch kinh doanh toàn diện giúp bạn biến ý tưởng tuyệt vời của mình thành một doanh nghiệp thành công.</p>
                                <a href="https://ideabuddy.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/play.png" class="card-img">
                                <h3>Voice generator</h3>
                                <p>Máy tạo giọng nói dựa trên trí tuệ nhân tạo. Tạo âm thanh chuyển văn bản thành giọng nói (TTS) thực tế bằng cách sử dụng Trình tạo giọng AI trực tuyến của chúng tôi và các giọng nói tổng hợp tốt nhất. Chuyển đổi văn bản thành giọng nói tự nhiên ngay lập tức và tải xuống dưới dạng tệp âm thanh MP3 và WAV.</p>
                                <a href="https://play.ht/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

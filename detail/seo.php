                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origon=seo" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/sur.png" class="card-img">
                                <h3>SEO & Copywrtiting</h3>
                                <p>SurferSEO là một trong những công cụ SEO tốt nhất để viết nội dung tối ưu hóa SEO tuyệt vời. Nó sẽ chỉ cho bạn những gì cần bao gồm trong các bài viết, từ khoá tốt nhất, điểm số SEO hiện tại và cách cải thiện, và đảm bảo mỗi bài viết đều được tối ưu hóa SEO và chất lượng hàng đầu. Có thể dùng thử miễn phí.</p>
                                <a href="https://surferseo.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/se.png" class="card-img">
                                <h3>SEO & Traffic estimator</h3>
                                <p>Tận dụng tiếp thị internet để đạt được kết quả có thể đo lường. Sử dụng một công cụ duy nhất để thực hiện SEO, tiếp thị nội dung, phân tích đối thủ, PPC và tiếp thị truyền thông xã hội.</p>
                                <a href="https://www.semrush.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/mo.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Morningscore là một trong những công cụ SEO toàn diện tốt nhất hiện có. Dễ dàng sửa chữa sức khỏe trang web của bạn và tối ưu hóa SEO cùng xếp hạng với công cụ SEO chơi game của họ.</p>
                                <a href="https://morningscore.io" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/jas.png" class="card-img">
                                <h3>SEO & Copywrtiting</h3>
                                <p>Tạo các bài viết blog, nghệ thuật và hình ảnh tuyệt vời, bản sao tiếp thị, email bán hàng, nội dung SEO, quảng cáo Facebook, nội dung web, chú thích, kịch bản video nhanh hơn 10 lần với trí tuệ nhân tạo. Jasper là Bộ tạo nội dung AI giúp bạn và đội ngũ vượt qua những khó khăn trong quá trình sáng tạo để tạo ra nội dung độc đáo tuyệt vời 10 lần nhanh hơn.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>SEO & Copywrtiting</h3>
                                <p>GETgenie là trợ lý SEO AI toàn diện của bạn. Bằng cách tổng hợp tất cả các khả năng bạn cần vào một ứng dụng WordPress duy nhất, GetGenie AI hoạt động như ma thuật, giúp bạn tiết kiệm thời gian và tiền bạc so với việc sử dụng 10+ công cụ khác. Vượt qua đối thủ với nghiên cứu đối thủ SERP và tối ưu hóa trò chơi SEO của bạn. Bài viết blog và bản sao bán hàng được hỗ trợ bởi AI, tận dụng cơ hội SEO với phân tích từ khóa SEO được hỗ trợ bởi trí tuệ nhân tạo.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>SEO & Copywrtiting</h3>
                                <p>WriteSonic.com là công cụ hỗ trợ viết tiên tiến sử dụng công nghệ AI tiên tiến giúp bạn viết tốt hơn, nhanh hơn và hiệu quả hơn. Với các tính năng như tự động viết lại văn bản, phân tích cảm xúc và gợi ý thời gian thực, WriteSonic.com đưa việc viết của bạn lên một tầm cao mới.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>SEO & Copywrtiting</h3>
                                <p>SinCode làm cho nội dung viết bằng trí tuệ nhân tạo của bạn trở nên nhân văn hóa để bạn không nhận được đánh giá tiêu cực từ Google. SinCode sẽ giúp bạn nâng cao SEO và tất cả các loại nội dung viết. Tạo nội dung tối ưu hóa SEO, không sao chép, cho blog, bài viết, trang web, email và tất cả các loại nội dung viết 10 lần nhanh hơn.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>SEO & Copywrtiting</h3>
                                <p>Công cụ AI SEO cho tiếp thị nội dung. Nội dung không gây hại đến thứ hạng của Google. INK có thể làm cho văn bản của bạn trở nên nhân văn hóa. Chọn từ khoá, xây dựng khuôn mẫu bài viết blog, viết toàn bộ bài viết blog và làm cho nó trông như được viết bởi một người sử dụng công cụ viết AI này.</p>
                                <a href="https://inkforall.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ctr.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Nền tảng Thực hiện SEO đầu tiên được trang bị trí tuệ nhân tạo. Tạo các trang web xếp hạng trên Google chỉ bằng cách cung cấp một từ khoá cho Trí tuệ nhân tạo. Nâng cao thứ hạng SERPs, tỷ lệ nhấp vào tự nhiên, thời gian lưu trú và Pogo Sticking nhờ lưu lượng truy cập tự nhiên từ hàng triệu thiết bị máy tính để bàn và di động kết nối từ các địa điểm IP cư trú của các nhà mạng di động hàng đầu từ tất cả các vị trí trên thế giới.</p>
                                <a href="https://www.ctrify.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/seo.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Chỉ có một công cụ AI SEO độc quyền với 10 lần hiệu quả vượt trội dành cho nhãn trắng trên thế giới. Nền tảng White Label SEO, PPC và Website Reseller miễn phí. Đăng ký để truy cập hơn 30 dịch vụ tiếp thị, các công cụ miễn phí, quy trình bán hàng, PPC và tạo trang web.</p>
                                <a href="https://seovendor.co/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/cop.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Copy.ai cung cấp cách nhanh nhất và hiệu quả nhất để tạo ra nội dung chất lượng cao. Copy.ai tạo ra nội dung thu hút độc giả và chuyển đổi họ trong khi tiết kiệm thời gian và tiền bạc nhờ công nghệ trí tuệ nhân tạo tiên tiến.</p>
                                <a href="https://www.copy.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/kaf.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Kafkai là một thuật toán học máy có thể viết các bài viết từ đầu. Công nghệ tiên tiến dành cho nhà tiếp thị và chuyên gia SEO.</p>
                                <a href="https://kafkai.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/spin.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>Nhận nội dung duy nhất với Spinrewriter. Xem cách viết lại một bài viết thành 500 bài viết chỉ trong 45 giây. Với công nghệ ENL, Spin Rewriter là công cụ hoàn hảo cho các chuyên gia SEO cần nội dung duy nhất và chất lượng con người để đạt thứ hạng cao trên Google.</p>
                                <a href="https://www.spinrewriter.com/free/summer-sale" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/long.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>Tạo blog mà cả con người và các công cụ tìm kiếm đều yêu thích bằng Trí tuệ nhân tạo. LongShot là trợ lý viết AI giúp bạn và nhóm của bạn tạo ra các blog hữu ích được xếp hạng trên Google.</p>
                                <a href="https://www.longshot.ai" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/typ.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Công cụ Nội dung Trí tuệ nhân tạo hiển nhiên nhất kết hợp viết AI và Trợ lý SEO.</p>
                                <a href="https://typli.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/grow.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Viết nội dung hoàn hảo thân thiện với SEO cho bài viết blog, trang web và bài viết bằng Trí tuệ nhân tạo. Tạo nội dung mà Google yêu thích chỉ trong chốc lát.</p>
                                <a href="https://www.growthbarseo.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/shine.png" class="card-img">
                                <h3>SEO & audi</h3>
                                <p>Công cụ Nghiên cứu Từ khóa và Kiểm tra trang web. Shine Ranker là công cụ kiểm tra trang web và nghiên cứu từ khóa SEO giúp đưa trang web của bạn lên hàng đầu trên Google và kiếm tiền từ đó.</p>
                                <a href="https://shineranker.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/mang.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Mangools là công cụ SEO tuyệt vời để tìm kiếm từ khóa tốt nhất, SERP cho bất kỳ địa điểm nào, xếp hạng, liên kết đối thủ và theo dõi đối thủ.</p>
                                <a href="https://mangools.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/rank.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Đẩy mạnh tăng trưởng tự nhiên với sự trợ giúp từ công cụ SEO All-in-One này. Công cụ SEO chuyên nghiệp cung cấp những thông tin độc đáo, phân tích đối thủ và theo dõi tiến độ không giới hạn.</p>
                                <a href="http://www.rankranger.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ser.png" class="card-img">
                                <h3>SEO</h3>
                                <p>Serpstat là một trong những công cụ growth hacking tốt nhất cho SEO, Marketing, PPC và nhiều lĩnh vực khác. Tối ưu hóa SEO với Serpstat.</p>
                                <a href="https://serpstat.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sera.png" class="card-img">
                                <h3>SEO</h3>
                                <p>SEranking là công cụ SEO toàn diện của bạn. Theo dõi xếp hạng từ khóa chính xác, phân tích đối thủ PPC/SEO, kiểm tra và giám sát liên kết trở lại (backlink), thực hiện kiểm tra website (audit) và rất nhiều chức năng khác.</p>
                                <a href="https://seranking.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/link.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>LinkWhisper giúp bạn xây dựng liên kết nội bộ. Đơn giản và hiệu quả để xây dựng liên kết nội bộ và tối ưu hóa SEO.</p>
                                <a href="https://linkwhisper.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/rankmart.png" class="card-img">
                                <h3>SEO</h3>
                                <p>RankMath là một plugin WordPress mạnh mẽ cho SEO. Tối ưu hóa nội dung của bạn với các gợi ý tích hợp và các quy tắc tốt nhất về SEO.Được đề xuất bởi một số phần mềm SEO tốt nhất.</p>
                                <a href="https://rankmath.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

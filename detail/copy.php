                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                            <a href="../customer.php?origin=copy" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                ...
                                <p>
                                    Tạo ra các bài viết blog, nghệ thuật và hình ảnh tuyệt vời, bản sao tiếp thị, email bán hàng, nội dung SEO, quảng cáo Facebook, nội dung web, chú thích, kịch bản video nhanh hơn gấp 10 lần với trí tuệ nhân tạo. Jasper là Trình tạo nội dung AI giúp bạn và đội ngũ của bạn vượt qua khó khăn trong sáng tạo để tạo ra nội dung tuyệt vời, độc đáo nhanh gấp 10 lần.
                                </p>
                                <a href="https://www.jasper.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ws.jpg" class="card-img">
                                <h3>Copywriting & Content</h3>
                                <p>
                                    WriteSonic.com là một công cụ hỗ trợ viết tinh vi sử dụng công nghệ AI tiên tiến để giúp bạn viết tốt hơn, nhanh hơn và hiệu quả hơn. Với các tính năng như việc tự động diễn giải lại, phân tích ngữ điệu và gợi ý thời gian thời gian thực, WriteSonic.com đưa việc viết của bạn lên một tầm cao mới.
                                </p>
                                <a href="https://writesonic.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <p>
                                    Copy.ai cung cấp cách nhanh nhất và hiệu quả nhất để tạo ra nội dung chất lượng cao. Copy.ai tạo ra nội dung thu hút độc giả và chuyển đổi họ trong khi tiết kiệm thời gian và tiền bạc nhờ công nghệ trí tuệ nhân tạo tiên tiến.
                                </p>
                                <a href="https://www.copy.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <p>
                                    Tạo bản sao chuyển đổi cao cho doanh nghiệp trực tuyến của bạn chỉ trong vài giây. Khám phá hơn 60 công cụ mạnh mẽ để tạo ra mô tả sản phẩm hấp dẫn, kịch bản video, khái niệm quảng cáo, bản sao, bài viết blog, nội dung truyền thông xã hội và nhiều hơn nữa.
                                </p>
                                <a href="https://nando.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/cos.png" class="card-img">
                                <h3>Copywriting & Content</h3>
                                <p>
                                    Cosmos AI là nền tảng tạo nội dung AI toàn diện của bạn. Tạo ra nội dung quan trọng nhất; cho dù đó là bài viết blog, chú thích truyền thông xã hội, hình ảnh AI, chuyển từ giọng nói thành văn bản, trợ lý lập trình hoặc bất cứ điều gì khác.
                                </p>
                                <a href="https://cosmosai.digital/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <h3>Copywriting & Content</h3>
                                <p>
                                    GETgenie là trợ lý SEO AI toàn diện của bạn. Bằng cách tổng hợp tất cả các khả năng bạn cần vào một ứng dụng WordPress duy nhất, GetGenie AI hoạt động như ma thuật, giúp bạn tiết kiệm thời gian và tiền bạc so với việc sử dụng 10+ công cụ khác.
                                </p>
                                <a href="https://getgenie.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <h3>Copywriting & Content</h3>
                                <p>
                                    SinCode giúp làm cho nội dung viết bằng trí tuệ nhân tạo của bạn trở nên sống động hơn để bạn không bị Google đánh giá tiêu cực. SinCode sẽ giúp bạn tăng cường SEO và mọi loại nội dung viết. Tạo ra nội dung tối ưu hóa SEO không vi phạm bản quyền cho blog, bài viết, website, email và mọi loại nội dung viết khác nhanh gấp 10 lần.
                                </p>
                                <a href="https://www.sincode.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ink.png" class="card-img">
                                <h3>Copywriting & Content</h3>
                                <p>
                                    Tiếp cận Marketing Nội dung AI mà không ảnh hưởng tiêu cực đến thương hiệu của bạn. Nội dung AI đang bị nghiêm cấm một cách nghiêm ngặt bởi Google và các trang web khác. INK for all có thể phát hiện nó. Hiện có một Nền tảng Nội dung AI toàn diện đã ưu tiên an ninh.
                                </p>
                                <a href="https://inkforall.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/co.png" class="card-img">
                                <h3>Content creation</h3>
                                <p>
                                    Sử dụng trình soạn thảo AI tiên tiến nhất để tạo ra những thứ phi thường. Đặt điểm kết thúc cho các vấn đề nhắc ChatGPT. Với Cohesive, bạn có thể tạo, chỉnh sửa và xuất bản một cách dễ dàng.
                                </p>
                                <a href="https://cohesive.so/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <h3>Copywriting & Content</h3>
                                <p>
                                    WordAI.com cung cấp công nghệ tạo nội dung tiên tiến được hỗ trợ bởi trí tuệ nhân tạo, cho phép bạn tạo ra nội dung duy nhất, dễ đọc và tối ưu hóa SEO chỉ với vài cú nhấp chuột. Nó cũng bao gồm các tính năng tiên tiến như tự động xoay vòng và tái cấu trúc đoạn văn và câu, giúp bạn tiết kiệm thời gian và công sức.
                                </p>
                                <a href="https://wordai.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ry.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>
                                    Rytr.me giúp bạn viết nội dung tối ưu hóa chuyển đổi gấp 10 lần. Rytr là trợ lý viết AI cho phép bạn tạo ra nội dung xuất sắc một cách nhanh chóng và giá rẻ.
                                </p>
                                <a href="https://rytr.me/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/aiwrite.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>
                                    AI-Writer.com là một nền tảng tạo nội dung được hỗ trợ bởi trí tuệ nhân tạo, tạo ra những bài viết chất lượng cao giống như con người trong vài phút. Với giao diện đơn giản và thuật toán học máy mạnh mẽ, bạn có thể nhanh chóng tạo ra nội dung cho các trang web, blog và tài liệu tiếp thị; tạo ra bài viết chỉ từ một tiêu đề bằng cách sử dụng các mô hình viết AI tiên tiến.
                                </p>
                                <a href="https://ai-writer.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            <div class="card">
                                <img src="./img/cont.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>Contentforge sẽ tạo tất cả nội dung văn bản cho bất cứ điều gì chỉ bằng một cú nhấp chuột. Tạo văn bản cho trang web, blog, bản sao quảng cáo, email, truyền thông xã hội và nhiều hơn nữa.</p>
                                <a href="https://contentforge.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/allai.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>AlliAI giúp bạn tối ưu hóa, tự động hóa, triển khai và mở rộng SEO. Tạo luật cho tối ưu hóa toàn diện trang web và áp dụng nhanh chóng các cập nhật mã cho các trang cụ thể. Bạn có thể triển khai các thay đổi nhanh chóng sau khi chỉnh sửa và tối ưu hóa văn bản, nội dung và mã trực tiếp trên trang trong trình duyệt của bạn. Làm SEO nhanh chóng, tiết kiệm chi phí và hiệu quả hơn bao giờ hết.</p>
                                <a href="https://www.alliai.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            ...
                            <div class="card">
                                <img src="./img/copy.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>Tạo ra Nội dung và Văn bản chỉ trong vài giây với AI. Sử dụng AI để tăng lượng truy cập và tiết kiệm hàng giờ công việc. Tự động viết văn bản duy nhất, hấp dẫn và chất lượng cao: từ bài đăng blog dài hoặc trang đích cho đến quảng cáo số trong vài giây.</p>
                                <a href="https://copymatic.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/orig.png" class="card-img">
                                <h3>AI & plagiarism checker</h3>
                                <p>Dành cho nhà xuất bản nội dung nghiêm túc, công cụ phát hiện AI và sao chép chính xác nhất. Được xây dựng đặc biệt cho nhà tiếp thị nội dung và chuyên gia SEO, công cụ phát hiện AI Chat GPT và GPT-4 chính xác nhất.</p>
                                <a href="https://originality.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            <div class="card">
                                <img src="./img/moon.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>
                                    Trí tuệ nhân tạo của Moonbeam sẽ mang đến cho bạn tất cả những gì bạn cần để viết nội dung dài hấp dẫn. Trở nên gấp đôi kỹ năng viết trong 10 phút.
                                </p>
                                <a href="https://www.gomoonbeam.com" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/hy.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Chuyển đổi vài từ khóa thành các bài viết, mô tả sản phẩm và văn bản truyền thông xã hội sáng tạo, sâu sắc với việc viết bằng trí tuệ nhân tạo - tất cả chỉ trong vài phút. Hãy thử miễn phí ngay hôm nay.
                                </p>
                                <a href="https://www.hypotenuse.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ep.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>
                                    Hãy để trí tuệ nhân tạo tạo ra nội dung cho blog, bài viết, trang web, mạng xã hội và nhiều hơn nữa. Sử dụng cho bất kỳ mục đích viết văn bản nào.
                                </p>
                                <a href="https://epagestore.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/di.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>
                                    Tạo kế hoạch tiếp thị chỉ trong vài giây bằng trí tuệ nhân tạo. Tìm ra các chiến thuật tăng trưởng tốt nhất cho doanh nghiệp của bạn với trí tuệ nhân tạo. Chuyển đổi tiếp thị thành chế độ tự động và phát triển.
                                </p>
                                <a href="https://app.digitalfirst.ai" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/isa.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Công cụ AI cho việc tạo nội dung. Viết bất cứ điều gì bằng trí tuệ nhân tạo. Viết, ghi chú, và chuyển văn bản thành giọng nói trong hơn 35+ ngôn ngữ.
                                </p>
                                <a href="https://isavant.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/hero.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Wordhero dành cho nhà văn, nhà tiếp thị và chủ doanh nghiệp. Viết nội dung tuyệt vời trong thời gian ngắn chỉ với vài cú nhấp chuột. Văn bản cho trang web, blog, bản sao tiếp thị và bất cứ thứ gì khác.
                                </p>
                                <a href="https://wordhero.co/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            <div class="card">
                                <img src="./img/li.png" class="card-img">
                                <h3>Paraphrasing</h3>
                                <p>
                                    Linguix là trợ lý viết AI sẽ giúp bạn tạo ra nội dung cho mọi mục đích tiếp thị, cũng như bán hàng, nhân sự, hỗ trợ và nhiều hơn nữa. Ngoài việc tạo ra nội dung, nó đi kèm với một công cụ kiểm tra ngữ pháp sẽ đảm bảo văn bản trông hoàn hảo.
                                </p>
                                <a href="https://linguix.com" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/boto.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Botowski là trợ lý viết AI cá nhân mới của bạn.
                                </p>
                                <a href="https://www.botowski.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/veg.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Tham gia thử nghiệm beta cho trợ lý tiếp thị trí tuệ nhân tạo thực vật đầu tiên trên thế giới.
                                </p>
                                <a href="https://veg3.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/easy.png" class="card-img">
                                <h3>Copywriting & avatars</h3>
                                <p>
                                    Hoàn thành công việc viết văn bản của bạn nhanh chóng và dễ dàng với công cụ trí tuệ nhân tạo này. Bạn cũng có thể sử dụng trình tạo hình ảnh avatar trí tuệ nhân tạo để tạo ra avatar. Easy-Peasy.AI tin rằng mọi người đều có câu chuyện để kể. Với các công cụ viết văn bản trí tuệ nhân tạo, họ giúp bạn kể câu chuyện của mình một cách hấp dẫn nhất có thể.
                                </p>
                                <a href="https://easy-peasy.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/simp.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Simplified AI Writer là trợ lý viết AI giúp tạo ra nội dung chất lượng cao cho blog, bài viết, mô tả sản phẩm, trang web và mạng xã hội.
                                </p>
                                <a href="https://simplified.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/monkey.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                ...
                                <a href="https://copymonkey.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            <div class="card">
                                <img src="./img/smith.png" class="card-img">
                                <h3>Copywriting</h3>
                                <a href="https://app.copysmith.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/creai.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>Creaitor giúp bạn viết nội dung một cách mạnh mẽ và biểu cảm về cảm xúc hơn.</p>
                                <a href="https://www.creaitor.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/wizi.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Sử dụng Trí tuệ nhân tạo của WiziShop để viết mô tả sản phẩm thương mại điện tử của bạn, tìm nguồn cảm hứng cho các bài viết trong tương lai, dễ dàng mở rộng quốc tế và tạo ra nhiều lưu lượng truy cập hơn cho cửa hàng của bạn.
                                </p>
                                <a href="https://wizishop.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ipa.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>ParagraphAI là ứng dụng viết AI viết nội dung rõ ràng, ngắn gọn và không có lỗi.</p>
                                <a href="https://paragraphai.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sudo.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Vượt qua cảm giác tắc trí với trợ lý viết AI kỳ diệu của chúng tôi. Đồng hành luôn sẵn có để tư vấn ý tưởng. Phản hồi beta mà không cần tìm beta readers. "Hiện hình, đừng kể"? Họ có một nút cho điều đó.
                                </p>
                                <a href="https://www.sudowrite.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/text.png" class="card-img">
                                <h3>Copywriting & rewriting</h3>
                                <p>Tạo bài viết blog hoàn hảo với văn bản tối ưu hóa SEO trong vài phút với Texta.</p>
                                <a href="https://texta.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/coge.png" class="card-img">
                                <h3>SEO & Copywriting</h3>
                                <p>Copygenius sử dụng trí tuệ nhân tạo để viết văn bản cho trang web, bản sao quảng cáo, blog, mô tả và bất cứ điều gì bạn cần viết văn bản cho.</p>
                                <a href="https://copygenius.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            <div class="card">
                                <img src="./img/shark.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>Shakespeare sẽ viết bản sao tiếp thị hiệu quả cho mọi mục đích tiếp thị sử dụng trí tuệ nhân tạo.</p>
                                <a href="https://www.shakespeare.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/textco.png" class="card-img">
                                <h3>Copywriting</h3>
                                <p>
                                    Text Cortex là công cụ trí tuệ nhân tạo duy nhất giúp bạn viết tất cả các đoạn văn bạn cần, cho dù đó là cho trang web, bài đăng blog, bản sao quảng cáo, cho mục đích tiếp thị hoặc bất cứ thứ gì khác - Text Cortex có thể làm điều đó một cách hiệu quả.
                                </p>
                                <a href="https://textcortex.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/para.png" class="card-img">
                                <h3>Copywriting & rewriting</h3>
                                <p>Paraphrase Tool sử dụng trí tuệ nhân tạo để tạo ra các biến thể của văn bản của bạn trong hơn 100 ngôn ngữ.</p>
                                <a href="https://paraphrasetool.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

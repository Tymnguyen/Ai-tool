                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=dev" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/ins.png" class="card-img">
                                <h3>Developers & low-code/ no-code</h3>
                                <p>Bằng cách sử dụng khả năng xử lý ngôn ngữ tự nhiên của OpenAI, Flatlogic cung cấp một tích hợp đặc biệt tạo một cấu trúc cơ sở dữ liệu dựa vào mô tả ứng dụng của người dùng. Sau đó, chỉ trong vài phút, Flatlogic Full-Stack Web Generator tạo ra một ứng dụng web hoàn chỉnh.</p>
                                <a href="https://www.insidr.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/tin.png" class="card-img">
                                <h3>Developers & low-code/ no-code</h3>
                                <p>Một bộ các API NLP dễ sử dụng và tiên tiến. Các API phổ biến: Tạo văn bản - Chuyển đổi/Giải đồn Bình chọn Tích hợp phân tích văn bản nhanh chóng và mạnh mẽ vào các ứng dụng của bạn. Từ phân loại chủ đề đến phân tích tâm trạng và trích xuất thực thể, chúng tôi đã giúp bạn hoàn tất. Thực hiện điều đó trong vài ngày, không phải vài tháng! Phân tích văn bản: Kiểm tra sao chép; Các bộ phân loại tùy chỉnh; Phân tích tâm trạng; Phân tích thực thể được đặt tên.</p>
                                <a href="https://tinq.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/vwo.png" class="card-img">
                                <h3>Marketing & low-code/ no-code</h3>
                                <p>Biến khách truy cập của bạn thành khách hàng trả tiền. Cài đặt thử nghiệm đầu tiên của bạn ngay lập tức.</p>
                                <a href="https://www.vwo.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/par.png" class="card-img">
                                <h3>Low-code / no-code</h3>
                                <p>Sử dụng một bộ phân tích tài liệu được điều khiển bởi trí tuệ nhân tạo để tự động trích xuất dữ liệu. Tự động trích xuất dữ liệu có cấu trúc từ các tệp PDF, email và các tài liệu khác.</p>
                                <a href="https://parsio.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

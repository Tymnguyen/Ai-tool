                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=website" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/10.png" class="card-img">
                                <h3>AI Website Builder</h3>
                                <p>Nền tảng WordPress được hỗ trợ bởi trí tuệ nhân tạo. Công cụ xây dựng trang web tự động, Hosting và PageSpeed Booster, để nói về những điều cơ bản. Tạo trang web nhanh chóng và dễ dàng thay đổi theo ý muốn của bạn. Tích hợp với WordPress</p>
                                <a href="https://10web.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ele.png" class="card-img">
                                <h3>AI Website Builder</h3>
                                <p>Elementor AI cho phép bạn sử dụng trí tuệ nhân tạo để xây dựng và tùy chỉnh các trang web WordPress. Elementor là công cụ xây dựng chủ đề WordPress tốt nhất với nhiều tương tác và công cụ có thể. Đây là giải pháp toàn diện cho các trang web WordPress của bạn</p>
                                <a href="https://elementor.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sys.png" class="card-img">
                                <h3>All-in-one</h3>
                                <p>Systeme.io là một nền tảng kinh doanh toàn diện giúp các doanh nhân tối ưu hóa hoạt động kinh doanh và phát triển doanh nghiệp của mình. Nền tảng cung cấp các tính năng như xây dựng trang web, tạo khóa học và quản lý dự án, tất cả trong một nơi. Với Systeme.io, các doanh nhân có thể tiết kiệm thời gian và công sức bằng cách quản lý tất cả các khía cạnh của doanh nghiệp từ một vị trí trung tâm, đồng thời tăng năng suất và phát triển.</p>
                                <a href="https://systeme.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/codede.png" class="card-img">
                                <h3>AI website builder</h3>
                                <p>Công cụ tạo trang web AI. Trong vòng vài phút, xây dựng và triển khai! Chỉ với một lệnh duy nhất, công cụ xây dựng trang web được hỗ trợ bởi trí tuệ nhân tạo của chúng tôi có thể giúp bạn khởi chạy, lưu trữ và xác thực trang web tiếp theo của bạn.</p>
                                <a href="https://codedesign.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/pagege.png" class="card-img">
                                <h3>Landingag</h3>
                                <p>Tạo ngay một trang đích từ ý tưởng sản phẩm của bạn. Với sự trợ giúp của trí tuệ nhân tạo, PageGenie chuyển đổi đề xuất của bạn thành một trang đích hoàn chỉnh. Dành ít thời gian tìm kiếm và nhận câu trả lời nhanh chóng từ tất cả tài liệu của bạn.</p>
                                <a href="https://pagegenie.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/clickfu.png" class="card-img">
                                <h3>Funnels</h3>
                                <p>ClickFunnels cung cấp một giải pháp toàn diện để tạo và quản lý các hệ thống bán hàng, mà không cần bất kỳ kiến thức kỹ thuật nào. Nền tảng cung cấp một loạt các mẫu có thể tùy chỉnh và tính năng kéo và thả để đơn giản hóa quá trình xây dựng hệ thống bán hàng. Với ClickFunnels, bạn có thể tăng tỷ lệ chuyển đổi, tối ưu quá trình bán hàng và phát triển doanh nghiệp của bạn, tất cả trong một nơi.</p>
                                <a href="https://www.clickfunnels.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sam.png" class="card-img">
                                <h3>Funnels</h3>
                                <p>SamCart đơn giản hóa thương mại điện tử bằng cách cung cấp một nền tảng để tạo và quản lý các trang thanh toán có tỷ lệ chuyển đổi cao. Nền tảng cung cấp các tính năng tiên tiến như bán hàng tăng cường chỉ bằng một cú nhấp chuột, các gói hàng đặt trước và các gói hàng sau khi mua để tăng giá trị đơn hàng trung bình của bạn. Với SamCart, bạn có thể tập trung vào việc phát triển doanh nghiệp mà không cần phải lo lắng về việc mã hóa hoặc thiết kế trang thanh toán, từ đó tăng doanh số bán hàng và lợi nhuận.</p>
                                <a href="https://checkout.samcart.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/shop.png" class="card-img">
                                <h3>Webshop</h3>
                                <p>Shopify là nền tảng thương mại điện tử hàng đầu giúp các doanh nghiệp của mọi quy mô dễ dàng thiết lập và quản lý cửa hàng trực tuyến của họ. Nền tảng cung cấp một loạt các tính năng, bao gồm công cụ xây dựng trang web dễ sử dụng, các tùy chọn thanh toán an toàn và các công cụ phân tích mạnh mẽ. Với Shopify, các doanh nghiệp có thể tập trung vào việc phát triển thương hiệu và doanh số bán hàng mà không cần lo lắng về việc quản lý các khía cạnh kỹ thuật của cửa hàng trực tuyến của họ.</p>
                                <a href="https://www.shopify.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/hello.png" class="card-img">
                                <h3>Popups</h3>
                                <p>Hello Bar là một công cụ tối ưu hóa chuyển đổi mạnh mẽ giúp các doanh nghiệp tăng tỷ lệ chuyển đổi trang web của họ. Nền tảng cho phép doanh nghiệp tạo và hiển thị các thông điệp cá nhân hấp dẫn và lời kêu gọi hành động đến khách truy cập trang web của họ. Với Hello Bar, các doanh nghiệp có thể cải thiện trải nghiệm người dùng trang web, tăng cường tương tác và tạo ra nhiều chuyển đổi hơn, tất cả trong một nền tảng dễ sử dụng.</p>
                                <a href="https://www.hellobar.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/convert.png" class="card-img">
                                <h3>Landingpages</h3>
                                <p>Convertri là một công cụ xây dựng trang đích nhanh chóng, linh hoạt và mạnh mẽ được thiết kế để giúp các doanh nghiệp tăng tỷ lệ chuyển đổi. Nền tảng cung cấp một loạt các tính năng tiên tiến như thay thế văn bản động, kiểm tra A/B và thiết kế phản hồi trên điện thoại di động. Với Convertri, các doanh nghiệp có thể tạo ra các trang đích có tỷ lệ chuyển đổi cao một cách nhanh chóng và dễ dàng, giúp tăng số lượng khách hàng tiềm năng, doanh số bán hàng và doanh thu.</p>
                                <a href="https://www.convertri.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/phone.png" class="card-img">
                                <h3>Website & Landingpages</h3>
                                <p>PhoneSites là một công cụ xây dựng trang web di động giúp các doanh nghiệp dễ dàng tạo và quản lý một trang web di động chuyên nghiệp. Nền tảng cung cấp một loạt các mẫu, tùy chọn tùy chỉnh và thiết kế phản hồi trên điện thoại di động để đảm bảo trải nghiệm người dùng liền mạch trên mọi thiết bị. Với PhoneSites, các doanh nghiệp có thể tiếp cận với một đối tượng khách hàng rộng hơn, cải thiện tầm nhìn trực tuyến của họ và tăng doanh số bán hàng bằng việc có một trang web được tối ưu hóa cho di động.</p>
                                <a href="https://phonesites.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/duda.png" class="card-img">
                                <h3>Website builder</h3>
                                <p>Duda là một công cụ xây dựng trang web dành cho các doanh nghiệp tiếp thị kỹ thuật số. Nền tảng không yêu cầu mã hóa này được thiết kế cho các công ty tiếp thị sẽ đáp ứng mọi nhu cầu tiếp thị.</p>
                                <a href="https://www.duda.co" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/site.png" class="card-img">
                                <h3>Website host</h3>
                                <p>Nhận dịch vụ lưu trữ web siêu nhanh với SiteGround. Mua tên miền với giá cả hợp lý và không cần lo lắng về vấn đề lưu trữ.</p>
                                <a href="https://world.siteground.com" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

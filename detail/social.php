                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=social" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                ...
                                <p>Để tức thì tạo ra email tiếp thị, tweet và các chuỗi bài viết với trí tuệ nhân tạo, nhập URL hoặc CHỦ ĐỀ. Chương trình trí tuệ nhân tạo này có thể tạo ra nội dung thông tin và tạo doanh số mở, đọc và chia sẻ.</p>
                                <a href="https://www.tugan.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <p>
                                    Với các tác phẩm sáng tạo được tạo ra bằng trí tuệ nhân tạo chỉ trong vài giây, AdCreative.ai tăng cường tiềm năng tiếp thị của bạn. Hãy vượt lên một bước so với đối thủ với sự trợ giúp của trình tạo văn bản trí tuệ nhân tạo và thông tin thời gian thực về thành công của chiến dịch tiếp thị của bạn. Công cụ trí tuệ nhân tạo này sẽ tiếp tục học hỏi và trở nên tốt hơn mỗi ngày. Bạn có thể tạo ra vô số bài viết chỉ trong chốc lát và tăng tỷ lệ chuyển đổi lên 14 lần.
                                </p>
                                <a href="https://www.adcreative.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/craw.png" class="card-img">
                                <h3>Social media</h3>
                                <p>Giải pháp cuối cùng cho Kết quả Kinh doanh có tỷ suất đầu tư cao. Tự động hóa quy trình làm việc với nội dung bằng cách tiết kiệm hàng trăm giờ trong việc nghiên cứu Niş, chỉ cần điền vào vài câu hỏi, sau đó dựa trên câu trả lời của họ tạo ra nội dung hoàn hảo cho khán giả mục tiêu của bạn.</p>
                                <a href="https://app.crawlq.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ws.jpg" class="card-img">
                                <h3>Captions & writing</h3>
                                <p>WriteSonic.com là một công cụ hỗ trợ viết hiện đại sử dụng công nghệ trí tuệ nhân tạo tiên tiến giúp bạn viết tốt hơn, nhanh hơn và hiệu quả hơn. Với các tính năng như tự động diễn đạt lại, phân tích ngữ điệu và gợi ý thời gian thực, WriteSonic.com đưa việc viết của bạn lên một tầm cao mới.</p>
                                <a href="https://writesonic.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/mori.png" class="card-img">
                                <h3>Viral video content</h3>
                                <p>Bạn tạo ra các video và Morise.ai sẽ biến chúng trở nên viral bằng trí tuệ nhân tạo. Được huấn luyện với nội dung phát hành tốt nhất trên YouTube, Morise.ai biết chính xác những gì cần có để một video trở nên viral, bạn có thể tập trung vào việc tạo nội dung.</p>
                                <a href="https://morise.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sub.png" class="card-img">
                                <h3>Highlighted video text</h3>
                                <p>Biến đổi video của bạn với phụ đề được hỗ trợ bởi trí tuệ nhân tạo. Phụ đề tự động được tạo ra với biểu tượng cảm xúc lý tưởng và nhấn mạnh thông minh các cụm từ. Văn bản được nhấn mạnh đẹp mắt cho mạng xã hội.</p>
                            ...
                            <div class="card">
                                ...
                                <p>Bạn có thể tạo ra các video chuyên nghiệp ngay lập tức bằng InVideo. 6000+ mẫu, hơn 8 triệu phương tiện chung, chuyển văn bản thành video AI và tính năng chỉnh sửa tuyệt vời. Nhờ các mẫu dễ sử dụng mà có thể tùy chỉnh nhanh chóng ngay cả bởi những người không có kiến thức trước đó, InVideo làm cho quá trình tạo video trở nên đơn giản.</p>
                                <a href="https://invideo.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/repu.png" class="card-img">
                                <h3>Social Media Distribution</h3>
                                <p>Mở rộng khán giả của bạn với Repurpose.IO. Đơn giản hóa quy trình làm việc với nội dung và tập trung vào việc tạo ra nội dung tuyệt vời. Nhanh chóng xây dựng mặt trực tuyến của bạn và mở rộng khán giả trên nhiều nền tảng một cách dễ dàng. Tái sử dụng nội dung từ YouTube, TikTok, Instagram, Facebook, Zoom, Google Drive, Dropbox và Audio Podcasts thành vô số tác phẩm tối ưu cho mỗi kênh. Đăng tải hoặc lên lịch đến các kênh bạn đã chọn.</p>
                                <a href="https://repurpose.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/fol.png" class="card-img">
                                <h3>Social Media Automation</h3>
                                <p>Tự động tạo nội dung và đăng trên mạng xã hội bằng trí tuệ nhân tạo. Phân tích dữ liệu tiên tiến, sản xuất nội dung hỗ trợ bởi trí tuệ nhân tạo và lên lịch tự động có thể được sử dụng để cải thiện chiến lược của bạn và tăng cường sự tương tác trên các nền tảng mạng xã hội của bạn.</p>
                                <a href="https://followr.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/pic.png" class="card-img">
                                <h3>Video</h3>
                                <p>Tự động tạo ra video ngắn, tập trung vào thương hiệu và dễ dàng chia sẻ từ nội dung dài của bạn. Đơn giản, tiết kiệm chi phí và không cần chuyên môn kỹ thuật hoặc cài đặt phần mềm. Tạo video ngắn mang thương hiệu từ nội dung dài, chuyển đổi kịch bản bán hàng thành nội dung video trong vài phút, biến blogposts của bạn thành video và tự động thêm chú thích.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>Video</h3>
                                <p>Synthesia.io cho phép bạn chuyển đổi văn bản đơn giản thành video chỉ trong vài giây. Đây hiện đang là một trong những nền tảng tốt nhất để tạo ra video trí tuệ nhân tạo. Nó được hàng ngàn doanh nghiệp sử dụng để sản xuất video trong 120 ngôn ngữ trong khi tiết kiệm đến 80% thời gian và tiền bạc của họ. Synthesia cung cấp một giải pháp hiệu quả về thời gian và chi phí thay thế cho việc tạo video truyền thống.</p>
                            ...
                            <div class="card">
                                ...
                                <p>Tối ưu quản lý mạng xã hội của bạn với ContentStudio.io. Nói lời tạm biệt với các công cụ mạng xã hội lộn xộn và khó hiểu, và chào mừng một giải pháp đơn giản nhưng mạnh mẽ toàn diện dành cho các công ty quảng cáo, thương hiệu và nhà tiếp thị. Hãy tổ chức và tối đa hóa năng suất với nền tảng dễ sử dụng cho phép bạn lập kế hoạch, tạo ra và lên lịch đăng các bài viết thu hút mắt cho các kênh phù hợp vào thời điểm tối ưu nhất. Hoàn thành nhiều công việc hơn trong thời gian ngắn nhất với cách dễ nhất để quản lý và phát triển các kênh mạng xã hội của bạn.</p>
                                <a href="https://contentstudio.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/oco.png" class="card-img">
                                <h3>Social Media Content</h3>
                                <p>Nền tảng để tạo, tự động tạo ra và lên lịch nội dung nhanh chóng. Tiếp thị nội dung, viết bản sao và mạng xã hội trong vài phút.</p>
                                <a href="https://www.ocoya.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ken.png" class="card-img">
                                <h3>Social Media Bot</h3>
                                <p>KENJI tối ưu hóa trò chơi Instagram của bạn. Bot Instagram được trang bị trí tuệ nhân tạo giúp bạn có được nhiều người theo dõi, lượt thích và tương tác. KENJI là một giải pháp tăng trưởng Instagram được trang bị trí tuệ nhân tạo. Không cần kiến thức kỹ thuật. Việc cài đặt dễ dàng của KENJI và công nghệ trí tuệ nhân tạo tiên tiến giúp tự động hóa việc tương tác trên Instagram và thu hút người theo dõi thực.</p>
                                <a href="https://kenji.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/pre.png" class="card-img">
                                <h3>Social media bot</h3>
                                <p>Predis.ai giúp bạn tạo ra những tác phẩm sáng tạo trên mạng xã hội tuyệt vời chỉ trong vài giây. Không cần trở thành một chuyên gia tạo nội dung; Predis.ai tạo ra hình ảnh, video, carousel và chú thích, tất cả trong một nơi. Liên kết với các nền tảng yêu thích của bạn, giúp bạn duy trì hoạt động trên mạng xã hội và có sẵn trong 18 ngôn ngữ.</p>
                                <a href="https://predis.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/many.png" class="card-img">
                                <h3>Facebook and Texting Bots</h3>
                                <p>Tự động hóa cuộc trò chuyện tương tác trong Instagram Direct Messages, Facebook Messenger và SMS để phát triển thương hiệu của bạn.</p>
                                <a href="https://manychat.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/cus.png" class="card-img">
                                <h3>Direct Messaging Automation</h3>
                                <p>Công cụ tự động hóa thông qua DM trên mạng xã hội đã được Meta phê duyệt dành cho Creators, quản lý mạng xã hội của chúng tôi với trí tuệ nhân tạo. Tự động hóa lên lịch, tạo nội dung và giám sát khách hàng tiềm năng. InstaChamp by MobileMonkey là công cụ hỗ trợ tăng trưởng khán giả, tương tác tức thì và các hệ thống bán hàng trên Instagram và Facebook.</p>
                                <a href="https://app.mobilemonkey.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/geta.png" class="card-img">
                                <h3>Social Media Bot</h3>
                                <p>Mua Lượt thích, Người theo dõi, Người đăng ký trên mạng xã hội (Facebook, Twitter, Instagram, YouTube và nhiều hơn nữa).</p>
                                <a href="https://www.getafollower.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/med.png" class="card-img">
                                <h3>Social Media Bot</h3>
                                <p>Media Mister có thể giúp bạn tăng sự hiện diện trên mạng xã hội. Họ cung cấp một loạt dịch vụ quảng bá để tăng sự hiện diện của bạn trên tất cả các nền tảng mạng xã hội.</p>
                                <a href="https://www.mediamister.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/dd.png" class="card-img">
                                <h3>Social media account</h3>
                                <p>Quản lý mạng xã hội của bạn với trí tuệ nhân tạo. Tự động lên lịch, tạo nội dung và giám sát khách hàng tiềm năng.</p>
                                <a href="https://ddevi.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=aibot" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/ti.jpg" class="card-img">
                                <h3>AI Trading Bot</h3>
                                <p>Công cụ quét cổ phiếu không thể thiếu cho tất cả các nhà giao dịch chủ động. Công nghệ Stock Racing cung cấp một cái nhìn hoàn toàn mới về việc quét thị trường. Chào mừng đến từ tương lai của việc quét cổ phiếu, mà Trade Ideas là duy nhất công ty cung cấp.</p>
                                <a href="https://www.trade-ideas.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sig.png" class="card-img">
                                <h3>AI Trading Bot</h3>
                                <p>Biến đơn hàng của bạn thành thông báo ngay lập tức. Không cần mã hóa. Bất kỳ thông báo nào từ bất kỳ nền tảng giao dịch nào có thể nhanh chóng, dễ dàng và đơn giản chuyển đổi thành đơn hàng thực hiện trong tài khoản môi giới bất kỳ sử dụng SignalStack.</p>
                                <a href="https://signa/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/tic.png" class="card-img">
                                <h3>AI Trading Bot</h3>
                                <p>Hơn 1 tỷ lần so sánh các chiến lược giao dịch cổ phiếu. Các công cụ giao dịch bot AI như AI robot; tín hiệu, tài khoản ảo, dự đoán xu hướng AI và nhiều hơn thế nữa.</p>
                                <a href="https://tickeron.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/pio.png" class="card-img">
                                <h3>AI Trading Bot</h3>
                                <p>Tự động mua thấp và bán cao với bot giao dịch tiền điện tử độc quyền. Các bot tự động giao dịch tích hợp sẵn có thể giúp bạn tự động mua giá rẻ và bán giá cao tự động quanh thời gian 24/7 trong khi bạn dành thời gian làm những điều bạn yêu thích cùng với những người bạn yêu quý. Để cho bot lo lắng về biến động thị trường. </p>
                                <a href="https://www.pionex.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/cryp.png" class="card-img">
                                <h3>AI Trading Bot</h3>
                                <p>Bot giao dịch tiền điện tử có khả năng lập trình nhất từng có. Dành thời gian cho những việc quan trọng. Tự động hóa giao dịch của bạn và dễ dàng quản lý danh mục, theo dõi biến động giá và mua/bán tự động. Truy cập vào một nền tảng giao dịch xã hội với tính năng sao chép giao dịch.</p>
                                <a href="https://www.cryptohopper.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

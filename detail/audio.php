                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=audio" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                ...
                                <h3>Text to Speech & AI Character</h3>
                                <p>Synthesia.io cho phép bạn chuyển đổi văn bản đơn giản thành video chỉ trong vài giây. Hiện đang là một trong những nền tảng tốt nhất để tạo video AI. Nó được sử dụng bởi hàng nghìn doanh nghiệp để sản xuất video trong 120 ngôn ngữ và tiết kiệm tới 80% thời gian và tiền bạc của họ. Synthesia cung cấp một giải pháp hiệu quả về thời gian và chi phí thay thế cho việc tạo video truyền thống.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>Text to Speech & AI Character</h3>
                                <p>Ngay lập tức tạo ra các bộ phim được tạo bởi AI với việc viết đơn giản bằng ứng dụng 99% Reality AI Avatar. Tạo các bộ phim AI chân thực dễ dàng và nhanh chóng. Để có được bộ phim AI đầu tiên của bạn trong không quá năm phút, chỉ cần chuẩn bị kịch bản của bạn và sử dụng công cụ Text-to-Speech của chúng tôi.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>Text to Voice</h3>
                                <p>Tạo một video duy nhất và cá nhân hóa nó cho hàng nghìn người nhận. Gửi qua bất kỳ kênh nào và đo lường kết quả ngay lập tức. Bạn có thể làm điều này bằng cách ghi âm mẫu của mình, kết nối dữ liệu và sau đó tạo các video cá nhân hóa.</p>
                                <a href="https://play.ht/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/des.png" class="card-img">
                                <h3>Text to Voice</h3>
                                <p>Tạo mô hình chuyển văn bản thành giọng nói của bạn. Thử nghiệm trực tiếp.</p>
                                <a href="https://www.descript.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/w.png" class="card-img">
                                <h3>Text to Voice</h3>
                                <p>Tạo giọng nói trực tuyến từ văn bản. Nền tảng giọng nói hàng đầu cho AI là WellSaid Labs. Nó được sử dụng bởi hàng nghìn doanh nghiệp để tạo nội dung và trải nghiệm hấp dẫn trong khi tiết kiệm thời gian và tiền bạc mà không làm giảm chất lượng.</p>
                                <a href="https://wellsaidlabs.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/r.png" class="card-img">
                                <h3>Audio to Text</h3>
                                <p>Sử dụng Rythmex Converter trực tuyến để chuyển đổi âm thanh thành văn bản. Chuyển đổi âm thanh thành văn bản đơn giản, nhanh chóng và chính xác.</p>
                                <a href="https://rythmex.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/lin.png" class="card-img">
                                <h3>Text to Voice</h3>
                                <p>Trình tạo giọng nói AI với hơn 600+ giọng nói trong 80+ ngôn ngữ, chuyển đổi văn bản thành giọng nói chỉ trong vài giây, dễ dàng xuất giọng nói của bạn dưới định dạng MP3 hoặc WAV.</p>
                                <a href="https://www.listnr.tech" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/au.jpg" class="card-img">
                                <h3>Music</h3>
                                <p>Tạo các mẫu trống độc đáo bằng trí tuệ nhân tạo. Sử dụng plugin đột phá này để tạo ra vô số mẫu trống, hoàn toàn miễn phí sử dụng.</p>
                                <a href="https://audialab.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/mu.png" class="card-img">
                                <h3>Music</h3>
                                <p>Mubert là một hệ sinh thái âm nhạc miễn phí dành cho các nhà sáng tạo nội dung, thương hiệu và nhà phát triển. Âm nhạc chất lượng cao có thể làm nổi bật nội dung của bạn.</p>
                                <a href="https://mubert.com" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/pod.png" class="card-img">
                                <h3>Audio Editing</h3>
                                <p>Nền tảng duy nhất cho việc kể chuyện truyền hình. Công cụ trí tuệ nhân tạo tuyệt vời cho những người tạo podcast hoặc bất kỳ ai làm việc với việc tạo video dài. Ghi âm chất lượng phòng thu, chỉnh sửa bằng trí tuệ nhân tạo và xuất khẩu mượt mà - tất cả trong một nền tảng web duy nhất.</p>
                                <a href="https://podcastle.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/cast.png" class="card-img">
                                <h3>Audio Editing</h3>
                                <p>Biến âm thanh thành nội dung, như ma thuật. Tải lên file MP3 của bạn, tải xuống toàn bộ nội dung đã hoàn thiện. Biến âm thanh của bạn thành các mảnh nội dung sẵn sàng đăng.</p>
                                <a href="https://www.castmagic.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=customer" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/caff.png" class="card-img">
                                <h3>Customer Support</h3>
                                <p>Giải quyết vấn đề của khách hàng gấp 10 lần nhanh hơn với trí tuệ nhân tạo. Caffeinated CX là công cụ tự động hoàn thành AI giúp đội ngũ hỗ trợ của bạn giải quyết các yêu cầu hỗ trợ nhanh hơn gấp 10 lần</p>
                                <a href="https://www.caffeinatedcx.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/hi.png" class="card-img">
                                <h3>Customer Support</h3>
                                <p>Hỗ trợ khách hàng dễ dàng hơn với trí tuệ nhân tạo. Cung cấp hỗ trợ nhanh chóng và cá nhân hóa. Chạy phần mềm từ bên trong Gmail.</p>
                                <a href="https://hiverhq.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/let.png" class="card-img">
                                <h3>Customer Support</h3>
                                <p>ChatGPT cho trang web của bạn. Sử dụng chatbot được lập trình để trả lời các câu hỏi từ khách hàng hoặc các thành viên nhân viên ngay lập tức. Dễ dàng trả lời câu hỏi của khách hàng. Nền tảng cho phép bạn hoàn toàn thiết kế chatbot của mình để phù hợp với giọng điệu và phong cách của thương hiệu và phù hợp với các trường hợp sử dụng cụ thể và yêu cầu kinh doanh.</p>
                                <a href="https://letsask.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/won.png" class="card-img">
                                <h3>Customer Support</h3>
                                <p>Tạo ngay lập tức một chatbot AI bằng cách sử dụng cơ sở kiến thức của bạn. Tạo một chatbot tùy chỉnh được cung cấp bởi ChatGPT trong 5 phút bằng cách chia sẻ URL của trang web của bạn hoặc tải lên bất kỳ tệp PDF nào.</p>
                                <a href="https://wonderchat.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sim.png" class="card-img">
                                <h3>Customer Support</h3>
                                <p>Không bao giờ bỏ lỡ cuộc gọi từ khách hàng nữa. Sử dụng trí tuệ nhân tạo để trả lời những cuộc gọi bị bỏ sót nếu bạn chuyển hướng chúng đến một số khác hoặc có một số mới.</p>
                                <a href="https://www.simplephones.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

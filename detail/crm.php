                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=crm" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                ...
                                <h3>Extract</h3>
                                <p>Trích xuất và giám sát bất kỳ dữ liệu nào chỉ trong vài giây từ bất kỳ trang web nào với browse AI. Dễ dàng huấn luyện robot mà không cần mã code.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>Al analystic</h3>
                                <p>Phân tích dữ liệu là một thách thức; flowpoint.ai giúp việc này trở nên đơn giản. Sử dụng trí tuệ nhân tạo để cải thiện tỷ lệ chuyển đổi, ưu tiên các giải pháp hữu ích và tăng ROI thông qua các quyết định dựa trên dữ liệu. Tìm kiếm những gợi ý thực tế để tối đa hóa tiềm năng của trang web của bạn. Sử dụng trí tuệ nhân tạo cho phân tích hệ thống liên quan đến nhiều lĩnh vực, gợi ý dựa trên trí tuệ nhân tạo, ghi nhận các sự kiện của người dùng và tối ưu hóa tỷ lệ chuyển đổi.</p>
                                <a href="https://flowpoint.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/make.png" class="card-img">
                                <h3>Email & CRM</h3>
                                <p>Biến cách bạn làm việc với sức mạnh tự động hóa trong một nền tảng trực quan. Xây dựng và tự động hóa bất cứ điều gì từ các nhiệm vụ và quy trình làm việc đến ứng dụng và hệ thống một cách dễ dàng. Nói lời tạm biệt với các nền tảng khác nhau và chào đón tích hợp mượt mà, với hàng ngàn tích hợp ứng dụng sẵn có và khả năng kết nối với bất kỳ ứng dụng trực tuyến nào bằng các công cụ mã không cần mã. Tối ưu hóa quy trình làm việc và tối đa hóa năng suất với Make.com.</p>
                                <a href="https://www.make.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/phan.png" class="card-img">
                                <h3>leadgen</h3>
                                <p>PhantomBuster nổi bật như một trò chơi thay đổi trong không gian tự động hóa với khả năng tiên tiến để trích xuất dữ liệu và tự động hóa quy trình làm việc phức tạp. Nói lời tạm biệt với việc nhập dữ liệu thủ công và các nhiệm vụ lặp đi lặp lại, vì các thuật toán AI của PhantomBuster sẽ làm công việc nặng nhọc thay bạn. Với tốc độ, độ chính xác và khả năng mở rộng không đối thủ, PhantomBuster là công cụ tự động hóa duy nhất mà bạn cần để tối đa hóa năng suất và thúc đẩy sự phát triển kinh doanh.</p>
                                <a href="https://phantombuster.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sma.png" class="card-img">
                                <h3>Email & CRM</h3>
                                <p>Tạo hàng ngàn email và tin nhắn cá nhân chỉ trong vài giây và nhận được 8 lần nhiều câu trả lời hơn với Smartwriter.ai. Tự động hóa quy trình viết email và sản xuất ra số lượng lớn 40 lần nhanh hơn và tiết kiệm chi phí hơn.</p>
                                <a href="https://www.smartwriter.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/zopto.png" class="card-img">
                                <h3>Linkedin automation</h3>
                                <p>Zopto là công cụ tự động hóa LinkedIn hàng đầu giúp bạn mở rộng hoạt động bán hàng và tiếp cận khách hàng. Với các tính năng tiên tiến và giao diện trực quan, Zopto giúp bạn dễ dàng tìm và kết nối với khách hàng mục tiêu, tự động hóa các nhiệm vụ lặp đi lặp lại và tạo ra cơ hội tiềm năng. Dù bạn là một chuyên gia bán hàng, nhà tiếp thị hay nhà tuyển dụng, Zopto là giải pháp tối ưu giúp bạn tối đa hóa hiện diện trên LinkedIn và đạt được mục tiêu kinh doanh của bạn.</p>
                                <a href="https://zopto.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/tap.png" class="card-img">
                                <h3>linkedin automation</h3>
                                <p>Tận dụng tiềm năng của trí tuệ nhân tạo trên LinkedIn. Chỉ trong mười phút mỗi ngày, phát triển thương hiệu cá nhân của bạn. Công cụ toàn diện để xây dựng thương hiệu cá nhân trên LinkedIn là Taplio cho LinkedIn. Cải thiện nội dung LinkedIn của bạn, lên lịch thời gian cập nhật, tạo kết nối mới và theo dõi tiến trình của bạn.</p>
                                <a href="https://taplio.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/snov.png" class="card-img">
                                <h3>Outreach Automation</h3>
                                <p>Snov.io là công cụ toàn diện nhất cho việc tiếp cận và tạo nguồn khách hàng tiềm năng, giúp bạn tối ưu hóa hoạt động bán hàng và marketing. Với các tính năng mạnh mẽ như xác minh email, tìm kiếm email và bộ lọc tìm kiếm tiên tiến, Snov.io giúp bạn dễ dàng tìm và tiếp cận đối tượng khách hàng mục tiêu. Dù bạn đang tìm cách xây dựng danh sách email, tạo nguồn khách hàng tiềm năng hay phát triển kinh doanh, Snov.io cung cấp các công cụ bạn cần để thành công.</p>
                                <a href="https://snov.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/active.png" class="card-img">
                                <h3>CRM & Email</h3>
                                <p>ActiveCampaign là nền tảng bán hàng và marketing đầy đủ, thống nhất dữ liệu khách hàng và tự động hóa quy trình kinh doanh của bạn. Với sự kết hợp sáng tạo của tự động hóa và CRM, ActiveCampaign cho phép bạn tạo ra trải nghiệm cá nhân hóa cho khách hàng trên tất cả các điểm tiếp xúc. Nói lời tạm biệt với các hệ thống tách biệt và chào đón một nền tảng thống nhất giúp bạn phát triển kinh doanh, xây dựng mối quan hệ và thúc đẩy doanh số.</p>
                                <a href="https://www.activecampaign.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/awe.png" class="card-img">
                                <h3>CRM & Email</h3>
                                <p>AWeber là nền tảng email marketing hàng đầu giúp các doanh nghiệp kết nối với khách hàng và thúc đẩy sự phát triển. Với trình chỉnh sửa kéo và thả thông minh, các mẫu tùy chỉnh và khả năng tự động hóa tiên tiến, AWeber giúp việc tạo và gửi các chiến dịch email dễ dàng và hiệu quả. Dù bạn mới bắt đầu hay muốn nâng cao email marketing của mình lên một tầm cao mới, AWeber là giải pháp hoàn hảo giúp bạn đạt được mục tiêu của mình.</p>
                                <a href="https://www.aweber.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/dux.png" class="card-img">
                                <h3>Linkedin auomation</h3>
                                <p>LinkedIn automation trở nên dễ dàng với dux-soup. Quản lý toàn bộ quy trình bán hàng, theo dõi hiệu suất và đặt nhiều cuộc họp bán hàng hơn.</p>
                                <a href="https://www.dux-soup.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/kle.png" class="card-img">
                                <h3>auomation</h3>
                                <p>Klenty là một nền tảng tương tác bán hàng. Thực hiện một cách có hệ thống các chiến dịch tiếp cận và tối đa hóa số lượng cuộc họp và doanh số bán hàng.</p>
                                <a href="https://www.klenty.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/maill.png" class="card-img">
                                <h3>auomation</h3>
                                <p>Với Mailrush, bạn có thể tự động hóa các chiến dịch tiếp cận và theo dõi mà không cần nỗ lực. Đây là dịch vụ gửi email và nhà cung cấp tiếp cận email B2B.</p>
                                <a href="https://mailrush.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sale.png" class="card-img">
                                <h3>Auomation</h3>
                                <p>Tự động hóa chiến lược tiếp cận khách hàng lạnh của bạn với saleshandy. Gửi email được cá nhân hóa và có độ tin cậy cao tự động.</p>
                                <a href="https://www.saleshandy.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/oc.png" class="card-img">
                                <h3>Linkedin auomation</h3>
                                <p>LinkedIn automation trở nên đơn giản và hiệu quả. Công cụ tự động hóa toàn diện này sẽ giúp bạn đơn giản hóa việc tìm kiếm khách hàng tiềm năng, phát triển kinh doanh và tăng số cuộc họp bán hàng.</p>
                                <a href="https://octopuscrm.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sal.png" class="card-img">
                                <h3>outreach auomation</h3>
                                <p>Tự động hóa các nỗ lực tiếp cận và chốt khách hàng tiềm năng nhanh hơn. LinkedIn automation giúp tạo ra khách hàng tiềm năng và doanh số bán hàng một cách nhanh chóng. Dành cho các công ty quảng cáo, đội ngũ bán hàng và start-up.</p>
                                <a href="https://salesflow.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

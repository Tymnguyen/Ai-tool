                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=art" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                ...
                                <h3>Image & Copywriting</h3>
                                <p>Tạo ra các bài viết blog, nghệ thuật và hình ảnh tuyệt vời, bản sao tiếp thị, email bán hàng, nội dung SEO, quảng cáo Facebook, nội dung web, phụ đề, kịch bản video, nhanh gấp 10 lần với trí tuệ nhân tạo (AI). Jasper là Trình tạo nội dung AI giúp bạn và nhóm của bạn vượt qua khối lập trình sáng tạo để tạo ra nội dung tuyệt vời, độc đáo gấp 10 lần nhanh chóng.</p>
                                <a href="https://www.jasper.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/get.png" class="card-img">
                                <h3>Avatar</h3>
                                <p>Tất cả những gì bạn cần để tạo ra những hình ảnh và nghệ thuật tuyệt vời với trí tuệ nhân tạo (AI). Công cụ nghệ thuật AI thần kỳ. Tạo ra những hình ảnh độc đáo, chỉnh sửa những hình ảnh hiện có, mở rộng hình ảnh ra khỏi ranh giới ban đầu và nhiều hơn nữa.</p>
                                <a href="https://getimg.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/chart.png" class="card-img">
                                <h3>Image Generator</h3>
                                <p>Tạo ra những hình ảnh 4K tuyệt vời, nghệ thuật truyền thông xã hội, quảng cáo và nội dung văn bản chỉ với một cú nhấp chuột.</p>
                                <a href="https://gocharlie.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/cre.png" class="card-img">
                                <h3>Social Media Creative</h3>
                                <p>Với những tác phẩm sáng tạo do trí tuệ nhân tạo (AI) tạo ra chỉ trong vài giây, AdCreative.ai nâng cao tiềm năng tiếp thị của bạn. Hãy vượt lên một bước so với đối thủ với sự trợ giúp của trình tạo văn bản AI và thông tin thời gian thực về thành công của chiến dịch tiếp thị của bạn. Công cụ AI sẽ tiếp tục học hỏi và ngày càng trở nên tốt hơn. Bạn có thể tạo ra vô số bài đăng trong thời gian ngắn và tăng tỷ lệ chuyển đổi lên 14 lần.</p>
                            ...
                            <div class="card">
                                ...
                                <h3>Image Generator</h3>
                                <p>Với công cụ chỉnh sửa hình ảnh AI của họ, bạn có thể tạo ra những hình ảnh nổi bật chỉ trong vài giây. Không cần Photoshop hay Illustrator, bạn có thể loại bỏ các phần không mong muốn, thay đổi phông nền hoặc mở rộng hình ảnh. Bạn có thể sử dụng từ để vẽ hình ảnh, hoặc để trí tuệ nhân tạo tạo ra những bức ảnh hồ sơ đẹp của bạn.</p>
                                <a href="https://www.canva.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/mag.png" class="card-img">
                                <h3>Image Generator</h3>
                                <p>Với công cụ chỉnh sửa hình ảnh AI của họ, bạn có thể tạo ra những hình ảnh nổi bật chỉ trong vài giây. Không cần Photoshop hay Illustrator, bạn có thể loại bỏ các phần không mong muốn, thay đổi phông nền hoặc mở rộng hình ảnh. Bạn có thể sử dụng từ để vẽ hình ảnh, hoặc để trí tuệ nhân tạo tạo ra những bức ảnh hồ sơ đẹp của bạn.</p>
                                <a href="https://magicstudio.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/phoai.jpg" class="card-img">
                                <h3>Photo Studio</h3>
                                <p>Người đầu tiên artificial photo studio trên thế giới được gọi là Photo AI. Mô hình hình ảnh do AI tạo ra có thể được sử dụng để tạo ra những hình ảnh tổng hợp. Những bức ảnh bạn có thể thấy dưới đây được tạo ra bằng Photo AI, tuy nhiên chúng không phải là thực sự.</p>
                                <a href="https://photoai.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/kre.png" class="card-img">
                                <h3>All Creatives</h3>
                                <p>Nền tảng đa năng cho logo đẹp mắt, bài viết trên mạng xã hội, quảng cáo, magic resize, viết AI, loại bỏ nền, bộ công cụ thương hiệu, quản lý nhiều thương hiệu, hoá đơn và nhiều hơn nữa.</p>
                                <a href="https://www.kreateable.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

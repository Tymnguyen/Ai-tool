                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=e" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                ...
                                <p>Nền tảng WordPress được hỗ trợ bởi trí tuệ nhân tạo. Tự động xây dựng trang web, lưu trữ và tăng tốc trang (PageSpeed Booster), để kể đến một số tính năng. Tạo các trang web nhanh chóng và dễ dàng thay đổi chúng theo ý muốn. Tích hợp với WordPress.</p>
                                <a href="https://10web.io/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/bra.png" class="card-img">
                                <h3>AI Webshop</h3>
                                <p>Với sức mạnh của trí tuệ nhân tạo, bạn có thể tạo cửa hàng trực tuyến chỉ trong tích tắc. Hãy biến ước mơ kinh doanh thương mại điện tử của bạn thành hiện thực bằng cách bắt đầu xây dựng cửa hàng hoạt động hoàn chỉnh ngay bây giờ.</p>
                                <a href="https://www.branchbob.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/drop.png" class="card-img">
                                <h3>Find Winning Products</h3>
                                <p>Khám phá các sản phẩm thành công để bán. Tìm và theo dõi các cửa hàng để có cái nhìn tổng quan về doanh thu, doanh số bán hàng, sản phẩm, ứng dụng và nhiều hơn thế nữa.</p>
                                <a href="https://www.dropship.io" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/tiny.png" class="card-img">
                                <h3>Email Marketing</h3>
                                <p>Giám đốc marketing AI của TinyEinstein có thể giúp bạn phát triển doanh nghiệp Shopify của mình nhanh gấp 10 lần. Đây là một trong những nền tảng marketing email AI tốt nhất cho thương mại điện tử.</p>
                                <a href="https://www.tinyeinstein.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/jas.png" class="card-img">
                                <h3>Content Generation</h3>
                                <p>Tạo bài viết blog tuyệt vời, nghệ thuật và hình ảnh, bản sao tiếp thị, email bán hàng, nội dung SEO, quảng cáo Facebook, nội dung web, chú thích, kịch bản video 10 lần nhanh chóng với trí tuệ nhân tạo. Jasper là Bộ tạo nội dung AI giúp bạn và đội ngũ vượt qua những khó khăn trong quá trình sáng tạo để tạo ra nội dung độc đáo tuyệt vời 10 lần nhanh hơn.</p>
                                <a href="https://www.jasper.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/ca.jpg" class="card-img">
                                <h3>Images & design</h3>
                                <p>Canva là công cụ hoàn hảo cho tất cả những người sáng tạo, thương hiệu và thêm nhiều hơn thế nữa. Có hàng nghìn mẫu và hiện cũng được trang bị công nghệ trí tuệ nhân tạo mới, cho phép tạo ra bất kỳ hình ảnh mà bạn miêu tả.</p>
                                <a href="https://www.canva.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/cre.png" class="card-img">
                                <h3>Social Media Creatives</h3>
                                <p>Với sức mạnh của những tác phẩm sáng tạo được tạo ra bằng trí tuệ nhân tạo chỉ trong vài giây, AdCreative.ai nâng cao tiềm năng marketing của bạn. Đi một bước vượt trội so với đối thủ với sự hỗ trợ của công cụ tạo văn bản AI và thông tin thời gian thực về hiệu quả của chiến dịch marketing. Công cụ AI sẽ tiếp tục học hỏi và trở nên tốt hơn mỗi ngày. Bạn có thể tạo ra vô số bài viết một cách nhanh chóng và tăng tỷ lệ chuyển đổi lên tới 14 lần.</p>
                                <a href="https://www.adcreative.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/tile.png" class="card-img">
                                <h3>AI Customer Service</h3>
                                <p>Nền tảng tương tác khách hàng tất cả trong một. Từ tạo lead đến sau bán hàng, từ WhatsApp đến trang web của bạn. Với cuộc trò chuyện trực tiếp trên nhiều kênh và chatbot.</p>
                                <a href="https://tiledesk.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/m.png" class="card-img">
                                <h3>AI Background Replacement</h3>
                                <p>Thay đổi phông nền với trí tuệ nhân tạo. Chụp ảnh sản phẩm chuyên nghiệp ngay lập tức chỉ từ một bức ảnh sản phẩm.</p>
                                <a href="https://app.mokker.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
                        </div>

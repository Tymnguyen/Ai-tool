                ...
                <div class="header">
                    ...
                    <div class="logohead1">
                        <details>
                            ...
                            <ul>
                                <a href="../customer.php?origin=chatplug" class="tk"><?php echo $user_name; ?></a>
                    ...
                    <div class="main">
                        ...
                        <div class="card-container vertical-layout">
                            <div class="card">
                                <img src="./img/pp.png" class="card-img">
                                <h3>Prompts</h3>
                                <p>Prompt Perfect giúp bạn dễ dàng tạo ra câu hỏi hoàn hảo. Tiện ích này hỗ trợ bạn tạo ra những câu hỏi được cấu trúc cẩn thận và hiệu quả, mang lại kết quả tốt nhất.</p>
                                <a href="https://promptperfect.jina.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/logo.png" class="card-img">
                                <h3>Extract Data</h3>
                                <p>Link Reader là tiện ích cần thiết cho bất kỳ ai cần trích xuất thông tin từ các liên kết. Tiện ích linh hoạt này có thể tóm tắt nội dung trang web, kiểm tra thông tin từ các bài báo tin tức và cung cấp một nguồn thông tin phong phú từ các nguồn trực tuyến.</p>
                                <a href="https://gptstore.ai/plugins/-gochitchat-ai" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/wolf.png" class="card-img">
                                <h3>Superchar Chatgpt</h3>
                                <p>Bằng cách tích hợp Wolfram, ChatGPT có quyền truy cập vào dữ liệu thời gian thực, khả năng tính toán toán học cải tiến và một tập dữ liệu được chăm chút kỹ lưỡng và phần lớn được xác minh. Việc tích hợp này giúp giải quyết các vấn đề như ảo tưởng AI, các phản hồi không chính xác và tính toán sai số toán học, làm cho ChatGPT trở nên thông minh đáng kể.</p>
                                <a href="https://www.wolfram.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/fo.png" class="card-img">
                                <h3>Extract data</h3>
                                <p>Trích xuất thông tin từ các tệp PDF chưa bao giờ dễ dàng đến vậy với tiện ích ChatWithPDF. Chỉ cần cung cấp liên kết đến tệp PDF trong câu hỏi của bạn, ChatGPT sẽ dễ dàng trích xuất thông tin bạn cần.</p>
                                <a href="https://foundr.ai/product/chatwithpdf" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/vid.png" class="card-img">
                                <h3>Videos</h3>
                                <p>Tiện ích Video Insights là một công cụ mạnh mẽ cho dữ liệu thời gian thực từ video như video trên YouTube. Chỉ cần cung cấp liên kết video và trình giải mã mã sẽ ghi âm lại các video. Cho dù bạn cần tóm tắt video, câu trả lời cụ thể cho các câu hỏi, hoặc bản ghi âm đầy đủ, Video Insights đều đáp ứng đầy đủ nhu cầu của bạn.</p>
                                <a href="https://www.whatplugin.ai/plugins/videoinsightsio" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/sx.png" class="card-img">
                                <h3>Image description</h3>
                                <p>Bạn đã bao giờ cần mô tả chi tiết về một hình ảnh? SceneXplain là tiện ích dành cho bạn. Bằng cách cung cấp URL hình ảnh, ChatGPT có thể tạo ra mô tả chi tiết về hình ảnh, ngay cả đối với các cảnh phức tạp với nhiều đối tượng và người.</p>
                                <a href="https://scenex.jina.ai/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/wtw.png" class="card-img">
                                <h3>Entertainment</h3>
                                <p>Bạn có đam mê xem phim và chương trình TV? Tiện ích "What to Watch" sẽ giúp bạn tìm kiếm giải trí hoàn hảo. Chỉ cần miêu tả loại phim hoặc chương trình TV mà bạn quan tâm, tiện ích sẽ đưa ra những gợi ý hợp lý.</p>
                                <a href="https://www.podchaser.com/podcasts/what-to-watch-814768" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>

                            <div class="card">
                                <img src="./img/in.png" class="card-img">
                                <h3>Grocery delivery</h3>
                                <p>Tiện ích InstaCart ChatGPT được thiết kế để giúp bạn diễn đạt yêu cầu lập kế hoạch bữa ăn của bạn bằng ngôn ngữ tự nhiên và nhanh chóng tạo ra danh sách "có thể mua" các loại thực phẩm hoặc nguyên liệu cần thiết.</p>
                                <a href="https://www.instacart.com/" target="_blank"><button class="truycap">Truy Cập Ngay</button></a>
                            </div>
